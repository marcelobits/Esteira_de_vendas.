...
O cliente entrava em contato solicitando o serviço de transporte,o atendete coletava as informações sobre a Viagem essenciais para a precificação.
...
Com essas informações o atendente calculava a precificação com base em uma tabela de papel, inseria as informações em um Doc e gerava um PDF para enviar para o cliente via Email.
